...
origImageDir = "/Users/mitchellmika/Desktop/PuO"
newImageDir = "/Users/mitchellmika/Desktop/NewPuO"
...
for image in os.listdir(origImageDir):
    ...
    for angle in range(0, 180, angleIncrement):
        ...
        skimage.io.imsave(f"{saveDir}/{os.path.splitext(image)[0]}_{angle}D.jpeg", newImg, check_contrast=False)
